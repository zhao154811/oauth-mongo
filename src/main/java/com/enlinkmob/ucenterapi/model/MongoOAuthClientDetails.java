...
public class MongoOAuthClientDetails implements Serializable {

    private static final long serialVersionUID = -7221324451472171298L;
    @Id
    private ObjectId _id;
    @Indexed(background = true, dropDups = true, unique = true, name = "clientId", direction = IndexDirection.ASCENDING)
